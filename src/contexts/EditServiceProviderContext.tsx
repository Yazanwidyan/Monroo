...
type ContextProps = {
    ...
    onOneMinuteVideoChange(e: React.ChangeEvent<HTMLInputElement> | React.MouseEvent<HTMLButtonElement>): void;
    onDemoReelChange(e: React.ChangeEvent<HTMLInputElement> | React.MouseEvent<HTMLButtonElement>): void;
    onPortfolioChange(e: React.ChangeEvent<HTMLInputElement> | React.MouseEvent<HTMLButtonElement>): void;
    onVideosChange(e: React.ChangeEvent<HTMLInputElement> | React.MouseEvent<HTMLButtonElement>): void;
    onAudiosChange(e: React.ChangeEvent<HTMLInputElement> | React.MouseEvent<HTMLButtonElement>): void;
    videosError: string;
    audiosError: string;
    ...
    onImagesChange(e: React.ChangeEvent<HTMLInputElement> | React.MouseEvent<HTMLButtonElement>): void;
    imagesError: string;
    imageFiles: File[];
};
...
export default function EditServiceProviderContextProvider({ providerProfile, children }) {
    ...
    const [oneMinuteVideoFile, oneMinuteVideoInputKey, onOneMinuteVideoChange, oneMinuteVideoError] = useFileInput({
        maxFileSizeKB: 10240,
        maxFileCount: 1,
    });

    const [portfolioFile, portfolioInputKey, onPortfolioChange, portfolioError] = useFileInput({
        maxFileSizeKB: 10240,
        maxFileCount: 1,
    });

    const [demoReelFile, demoReelInputKey, onDemoReelChange, demoReelError] = useFileInput({
        maxFileSizeKB: 10240,
        maxFileCount: 1,
    });

    const [videosFile, videosInputKey, onVideosChange, videosError] = useFileInput({
        maxFileSizeKB: 10240,
        maxFileCount: 2,
    });

    const [audiosFile, audiosInputKey, onAudiosChange, audiosError] = useFileInput({
        maxFileSizeKB: 10240,
        maxFileCount: 2,
    });

    const [imageFiles, imagesInputKey, onImagesChange, imagesError] = useFileInput({
        maxFileSizeKB: 5120,
        maxFileCount: 4,
    });
