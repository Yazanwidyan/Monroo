...
import { Box, Text, Avatar, VStack, Container, Input } from '@chakra-ui/react';
...
const Inbox = () => {
    ...
    const filteredRooms = rooms.filter((room) => room.senderName.toLowerCase().includes(searchTerm.toLowerCase()));
