...
const ProviderEventBookingCard: React.FC<{
  title: string;
  eventID: string;
  description: string;
  cost: string;
  ...
  return (
    <Box borderWidth="1px" mb={4} borderRadius="sm" p={4} boxShadow="base">
      ...
      <Flex align="center" justify="space-between" mb={2}>
        ...
        <Text fontSize="sm">
          Date:{" "}
          <span style={{ fontWeight: "bold" }}>{formatTimestamp(date)}</span>
        </Text>
      </Flex>
      <Flex align="center" justify="space-between" mb={2}>
        <Flex align="center">
        ...
        <Flex align="center">
          <FaRegCalendarAlt />
          <Text ml={2} fontSize="sm">
            Duration: <span style={{ fontWeight: "bold" }}>{duration}hrs</span>
          </Text>
        </Flex>
      </Flex>
      <Divider my={3} />
...
export default ProviderEventBookingCard;
