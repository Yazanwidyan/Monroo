    ...
    return (
        ...
        >
            ...
            <Box p="6">
                ...
                <Button onClick={() => navigate('register')} variant={'solid'} colorScheme="primary" mt="4" mx="auto" size="lg" borderRadius="full">
                    {buttonText}
                </Button>
            </Box>
        </Box>
    ...
    const cardData = [
        {
            ...
            points: ['Create Your Profile', 'Set Your Rate', 'Select Your Expertise', 'Find Opportunities', 'Get Hired'],
        ...
        },
        {
            ...
            points: ['Create Your Profile', 'Post a Job', 'Browse Talents', 'Contact Directly', 'Hire and Collaborate', 'Complete Your Project'],
    ...
    return (
        <Box bg="primary.50" pt="8" pb="8">
            <Container maxW={'7xl'}>
                ...
                <Flex p={8} gap={'4rem'} justifyContent={'space-around'} flexWrap="wrap">
