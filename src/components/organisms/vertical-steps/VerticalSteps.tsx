import { FaClipboardList, FaHandshake, FaStar, FaUserPlus } from 'react-icons/fa';
    ...
    return (
        <VerticalTimeline>
            <VerticalTimelineElement
                ...
                icon={<FaUserPlus />}
            >
                <h3 className="vertical-timeline-element-title">Step 1: Create Account</h3>
            ...
            >
                <h3 className="vertical-timeline-element-title">Step 2: Review Applicants</h3>
